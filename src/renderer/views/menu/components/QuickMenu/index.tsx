      ...
      <Content>
        <MenuItems>
          ...
          <MenuItem onClick={onUpdateClick} onClick={goToWebUIPage('version')} arrow>
            ...
            <br/>
            <MenuItemTitle>Bienvenido a {remote.app.name}</MenuItemTitle>
          </MenuItem>
          ...
          <MenuItem onClick={onAlwaysClick}>
            ...
            <MenuItemTitle>Siempre arriba</MenuItemTitle>
            <RightControl>
          ...
          >
            ...
            <MenuItemTitle>Extensiones</MenuItemTitle>
          </MenuItem>
          <Line />
          <MenuItem onClick={onFindInPageClick}>
            <Icon icon={ICON_FIND} />
            <MenuItemTitle>Buscar en página</MenuItemTitle>
            <Shortcut>Ctrl+F</Shortcut>
          </MenuItem>
          <MenuItem onClick={onPrintClick}>
            <Icon icon={ICON_PRINT} />
            <MenuItemTitle>Imprimir</MenuItemTitle>
