...
export default observer(() => {
  ...
  if (store.dialogContent === 'edit-search-engine') {
    dialogTitle = 'Editar motor de búsqueda';
  } else if (store.dialogContent === 'add-search-engine') {
    dialogTitle = 'Añadir motor de búsqueda';
  }
  ...
  const commands = [{
    ...
    },
    {
      ...
      name: "t:Establecer tema automático",
      command() {
        Promise.resolve().then(() => {
          setTimeout(function(){
            onThemeChange("auto");
