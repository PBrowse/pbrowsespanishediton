  ...
  return (
    ...
    {store.addressbarValue.startsWith('http://') && (
      <ToolbarButton
        toggled={false}
        icon={HTTP_ICON}
        alt="Página web no segura. Este tipo de páginas pueden robar tu información"
        size={16}
        onClick={onICCL}
        dense
        iconStyle={{ transform: 'scale(-1,1)' }}
    ...
    {store.addressbarValue.startsWith('pb://') && (
      ...
      <InputContainer>
        <Input
          ...
          onMouseUp={onMouseUp}
          onChange={onChange}
          placeholder="Busca o ingresa una URL"
