  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Title style={{ marginLeft: 20 }}>Diseño de página</Title>
        ...
        >
          ...
          <ContextMenuSeparator bigger></ContextMenuSeparator>
          <SwitchItem name="imageVisible">Mostrar imagen</SwitchItem>
          <SwitchItem disabled={!store.imageVisible} name="changeImageDaily">
            Cambiar la imagen diariamente
          </SwitchItem>
          
          <ContextMenuSeparator bigger></ContextMenuSeparator>
          <SwitchItem name="topSitesVisible">Ver top páginas web</SwitchItem>
          <SwitchItem name="quickMenuVisible">Ver menú rápido</SwitchItem>
           <ContextMenuSeparator bigger></ContextMenuSeparator>
          <SubTitle>Visibilidad de noticias:</SubTitle>
          ...
          >
            <Dropdown.Item value="true">Visible</Dropdown.Item>
            <Dropdown.Item value="false">Hidden</Dropdown.Item>
          </Dropdown> */}
        </div>
      </div>
    </ContextMenu>
